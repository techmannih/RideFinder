...
export default function Navbar() {
  ...
  const handleLogout = () => {
    // Perform logout actions (clear session, remove tokens, etc.)
    // Update Redux state to set isAuthenticated to false
            ...
            <div className="space-y-1 px-2 pb-3 pt-2">
              ...
              {!isAuthenticated ? (
                <>
                  ...
                  <a
                    href="/auth/signup"
                    className="mt-1 text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium"
                  >
                    Sign up
                  </a>
                </>
